    ...
    <div className="min-h-screen bg-void-black text-white p-6 pb-32 page-ambient">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-8 flex justify-end">
          <Link
            href="/upload"
            className="flex items-center gap-2 px-6 py-3 rounded-xl bg-kibo-bg border border-[#A9D9C7] text-[#A9D9C7] font-medium hover:bg-[#245244] transition-all shadow-lg"
          >
